 ...
 * as-is: its REST calls go through the host's own `fetch`, and every
 * previously published `@omadia/integration-confluence` release shipped this
 ...
 * against the live 0.3.2 artifact. The Telegram script nests its payload one
